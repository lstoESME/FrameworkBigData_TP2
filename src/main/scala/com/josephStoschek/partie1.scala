...
object partie1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    while (df1_count <8) {
      df1 = df1.union(Seq(("null","null","null","null")).toDF)
   ...
   //df1.show()
    ...
    while (df2_count <8) {
      df2 = df2.union(Seq(("null","null","null","null")).toDF)
    ...
    while (df3_count <8) {
      df3 = df3.union(Seq(("null","null","null","null")).toDF)
    ...
    while (df4_count <8) {
      df4 = df4.union(Seq(("null","null","null","null")).toDF)
    ...
    while (df5_count <8) {
      df5 = df5.union(Seq(("null","null","null","null")).toDF)
    ...
    while (df6_count < 8) {
      df6 = df6.union(Seq(("null","null","null","null")).toDF)
    ...
    val df = df10.union(df6)

    val col_c0_rename = df.withColumnRenamed("_c0", "amount")
